...
class TelegramBot:
    def __init__(self):
        ...
        logger.info("TelegramBot instance has been created.")

    def start(self):
        """Starts the bot polling in a background-thread-safe way."""
        logger.info("Telegram bot polling is starting...")
        self.application.run_polling(
            allowed_updates=Update.ALL_TYPES,
            stop_signals=None, # This is critical for running in a thread
        )
